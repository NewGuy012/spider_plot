...
%
%   options.AxesLimits = [1, 2, 1, 1, 1; 10, 8, 9, 5, 10]; % Axes limits [min axes limits; max axes limits]
%   spider_plot(P,...
%       'AxesLimits', options.AxesLimits);
%
%   % Example 3: Set fill option on. The fill transparency can be adjusted.
%
%   options.AxesLabels = {'S1', 'S2', 'S3', 'S4', 'S5'}; % Axes properties
%   options.AxesInterval = 2;
%   options.FillOption = 'on';
%   options.FillTransparency = 0.1;
%   spider_plot(P,...
%       'AxesLabels', options.AxesLabels,...
%       'AxesInterval', options.AxesInterval,...
%       'FillOption', options.FillOption,...
%       'FillTransparency', options.FillTransparency);
%
%   % Example 4: Maximum number of arguments.
%
%   options.AxesLabels = {'S1', 'S2', 'S3', 'S4', 'S5'}; % Axes properties
%   options.AxesInterval = 4;
%   options.AxesPrecision = 0;
%   options.AxesDisplay = 'one';
%   options.AxesLimits = [1, 2, 1, 1, 1; 10, 8, 9, 5, 10];
%   options.FillOption = 'on';
%   options.FillTransparency = 0.2;
%   options.Color = [1, 0, 0; 0, 1, 0; 0, 0, 1];
%   options.LineStyle = '--';
%   options.LineWidth = 3;
%   options.Marker = 'd';
%   options.MarkerSize = 10;
%   options.AxesFontSize = 12;
%   options.LabelFontSize = 10;
%   spider_plot(P,...
%       'AxesLabels', options.AxesLabels,...
%       'AxesInterval', options.AxesInterval,...
%       'AxesPrecision', options.AxesPrecision,...
%       'AxesDisplay', options.AxesDisplay,...
%       'AxesLimits', options.AxesLimits,...
%       'FillOption', options.FillOption,...
%       'FillTransparency', options.FillTransparency,...
%       'Color', options.Color,...
...
%               color, options.Marker, and line settings.
